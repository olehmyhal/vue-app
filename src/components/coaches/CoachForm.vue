<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{invalid: !lastName.isValid}">
            <label for="lastaname">Lastaname</label>
            <input type="text" id="lastaname" v-model.trim="lastName.val" @blur="clearValidity('lastName')"/>
        </div>
        <div class="form-control" :class="{invalid: !description.isValid}">
            <label for="description">Description</label>
            <textarea rows="5" type="text" id="description" v-model.trim="description.val" @blur="clearValidity('description')"/>
        </div>
        ...
        <p v-if="!formIsValid">Correct the form fields</p>
